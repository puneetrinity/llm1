...
def format_openai_response(ollama_response: Dict[str, Any], model: str, is_chat: bool = True) -> Dict[str, Any]:
    """Convert Ollama response to OpenAI format"""
    
    # Extract content
    content = ollama_response.get("response", "") or ollama_response.get("message", {}).get("content", "")
...
def truncate_messages(messages: List[Dict[str, str]], max_tokens: int = 4096) -> List[Dict[str, str]]:
