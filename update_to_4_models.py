...
class ModelConfigUpdater:
    def __init__(self):
        ...
        self.models_config = {
            'phi:3.5': {
                ...
                'keywords': ['calculate', 'solve', 'equation', 'math', 'formula', 'logic', 'analyze', 'scientific', 'reasoning', 'proof', 'theorem']
            },
            'mistral:7b-instruct-q4_0': {
                ...
                'keywords': ['what is', 'define', 'explain', 'fact', 'information', 'summary']
            },
            'gemma:7b-instruct': {
                'priority': 2,
                ...
                'keywords': ['code', 'function', 'program', 'debug', 'script', 'api', 'technical', 'documentation', 'programming', 'development']
            },
            'llama3:8b-instruct-q4_0': {
                ...
                'keywords': ['story', 'creative', 'write', 'poem', 'chat', 'narrative', 'storytelling', 'conversation', 'dialogue']
            }
        }
    ...
    def create_model_download_script(self):
        """Create download_4_models.py script"""
...
def main():
    ...
    # Download models sequentially for better reliability
    success_count = 0
